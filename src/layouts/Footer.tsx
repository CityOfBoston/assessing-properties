    ...
    <div className="cob-slim-footer">
        <div className="cob-slim-footer__content">
            <div className="cob-slim-footer__left">
                    <img src="/node_modules/cob-uswds/dist/img/cob-footer-icon.png" alt="City of Boston" className="cob-slim-footer__icon" />
                </div>
                ...
                <a href="http://www.cityofboston.gov/311/" className="cob-slim-footer__report">
                    ...
                    <img src="/node_modules/cob-uswds/dist/img/cob-311.svg" alt="311" className="cob-slim-footer__311-icon" />
                </a>
            </div>
        </div>
    </div>
