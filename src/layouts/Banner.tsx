        ...
        <header className="cob-site-banner__header">
          <div className="cob-site-banner__inner">
            <div className="cob-site-banner__left">
              <img src="/node_modules/cob-uswds/dist/img/cob-boston-icon.svg" alt="" className="cob-site-banner__icon" />
            ...
            <div className="cob-site-banner__right">
              <button className="cob-site-banner__button" aria-expanded="false" aria-controls="cob-site-banner-content-306611154">
                ...
                <img src="/node_modules/cob-uswds/dist/img/cob-angle-arrow-down.svg" alt="" className="cob-site-banner__toggle-icon-img" />
              </button>
            </div>
          </div>
          ...
          <div className="cob-site-banner__content" id="cob-site-banner-content-306611154" hidden>
            <div className="cob-site-banner__content-inner">
              <div className="cob-site-banner__info">
                  <img src="/node_modules/cob-uswds/dist/img/cob-city-hall-icon.svg" alt="" className="cob-site-banner__info-icon" />
                <div>
              ...
              <div className="cob-site-banner__info">
                <img src="/node_modules/cob-uswds/dist/img/cob-https-lock-icon.svg" alt="" className="cob-site-banner__info-icon" />
                <div>
